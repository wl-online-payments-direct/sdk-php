...
//    }
    ...
    public function testDeclinedPayoutExceptionForPayout()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\OnlinePayments\Sdk\Domain\PayoutResult', $payoutResult);
    ...
    public function testDeclinedPaymentException()
    {
        ...
        $this->assertInstanceOf('\OnlinePayments\Sdk\Domain\CreatePaymentResponse', $declinedPaymentException->getPaymentResult());
    ...
    public function testDeclinedRefundException()
    {
        ...
        $this->assertInstanceOf('\OnlinePayments\Sdk\Domain\RefundResponse', $declinedRefundException->getRefundResult());

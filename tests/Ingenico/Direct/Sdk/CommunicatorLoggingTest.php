...
class CommunicatorLoggingTest extends ClientTestCase
{
    ...
    {
        return $this->getMockBuilder('\Ingenico\Direct\Sdk\CommunicatorConfiguration')->disableOriginalConstructor()->getMock();
    }
    ...
    {
        return $this->getMockBuilder('\Ingenico\Direct\Sdk\ResponseClassMap')->disableOriginalConstructor()->getMock();
    }
